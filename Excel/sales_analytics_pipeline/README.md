...
Analysis on top of the clean CSVs from [Python/sales_analytics_pipeline](../../Python/sales_analytics_pipeline), using formulas only (no SQL, no Power BI build yet).
