...
**Contact:** juan.jose.carpi@hotmail.com - [LinkedIn](https://www.linkedin.com/in/juan-jose-carrascal-pinz%C3%B3n-0bba35223)
...
- **[Sales & Customer Analytics Pipeline](./sales_analytics_pipeline)** (Python + Excel + Power BI) - Python generates and cleans a synthetic sales dataset, Excel analyzes it with formulas, and Power BI summarizes sales, customers/products, and order quality.
