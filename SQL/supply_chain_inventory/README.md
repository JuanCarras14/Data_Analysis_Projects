...
Stockout and supplier performance analysis on top of the database from [Python/supply_chain_inventory](../../Python/supply_chain_inventory).

Other parts: [Python](../../Python/supply_chain_inventory) · [Power BI](../../PowerBI/supply_chain_inventory)
